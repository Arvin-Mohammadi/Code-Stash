...
download the [URDF File](https://github.com/Arvin-Mohammadi/Code-Stash/blob/main/ROS-Environment-Setup/assets/example_robot.urdf.xacro)
...
an example of URDF file: Head over to [Example number 2](https://github.com/Arvin-Mohammadi/Code-Stash/blob/main/ROS-Environment-Setup/assets/example2_robot.urdf.xacro) file and run these commands: 
